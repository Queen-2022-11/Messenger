...
import static com.example.chatting.chatwindo.reciverIImg;
import static com.example.chatting.chatwindo.senderImg;
...
public class meassagesAdapter extends RecyclerView.Adapter {
    Context context;
    ArrayList<msgModelclass> messagesAdpterArrayList;
    int ITEM_SEND=1;
    int ITEM_RECIVE=2;

    public meassagesAdapter(Context context, ArrayList<msgModelclass> messagesAdpterArrayList) {
